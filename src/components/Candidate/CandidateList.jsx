...
function CandidateList({ search, candidates, setCandidates, deletedCandidate, setDeletedCandidate }) {
  useEffect(() => {
  ...
  const deleteCandidate = (candidateKey) => {
    const newCadidateList = candidates.filter((candidate) => {
      return candidate.id !== candidateKey
    })

    const removedList = candidates.filter((candidate) => {
      const selectedCandidate = candidate.id === candidateKey
      return selectedCandidate
    })
    
    setDeletedCandidate([...deletedCandidate, removedList])
    setCandidates(newCadidateList)
    console.log(deletedCandidate)
    console.log(newCadidateList)
  }
  const renderCandidate = candidates
    .filter((candidate) => 
